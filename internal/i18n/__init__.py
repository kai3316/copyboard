...
_EN: dict[str, str] = {
    ...
    "settings_window.factory_reset_confirm": "This will delete ALL data and reset everything to defaults:\n\n• Device identity and private key\n• All paired devices\n• Clipboard history\n• All settings including encryption password\n• Log files\n\nClipSync will restart after reset.\n\nThis action CANNOT be undone. Continue?",
...
_ZH: dict[str, str] = {
    ...
    "settings_window.factory_reset_confirm": "此操作将删除所有数据并恢复为默认设置：\n\n• 设备身份和私钥\n• 所有已配对设备\n• 剪贴板历史记录\n• 所有设置（包括加密密码）\n• 日志文件\n\n重置后 ClipSync 将自动重启。\n\n此操作不可撤销。确认继续？",
