"""Internationalization support for CopyBoard.
...
_EN: dict[str, str] = {
    ...
    "settings.restart_required": "Restart CopyBoard for changes to take effect.",
    ...
    # UI labels
    "ui.app_title": "\U0001F4CB  CopyBoard",
    "ui.theme_dark": "☾  Dark",
    ...
    "ui.stop_discovery": "Stop discovery",
    "ui.hide_self": "Hide from network",
    ...
    "tray.about": "About CopyBoard",
    "tray.quit": "Quit",
    "tray.no_devices": "(no devices connected)",
    "tray.about_message": "CopyBoard — Cross-platform clipboard sharing\nShare your clipboard between Windows and Mac in real time.",
    "tray.about_title": "About CopyBoard",
    # Settings window
    "settings_window.title": "CopyBoard Settings",
    ...
    "settings_window.appearance_desc": "Customize the look and feel of CopyBoard.",
...
_ZH: dict[str, str] = {
    ...
    "settings.restart_required": "重启 CopyBoard 后生效。",
    ...
    "tray.about": "关于 CopyBoard",
    "tray.quit": "退出",
    "tray.no_devices": "（无已连接设备）",
    "tray.about_message": "CopyBoard — 跨平台剪贴板共享\n在 Windows 和 Mac 之间实时共享剪贴板。",
    "tray.about_title": "关于 CopyBoard",
    "settings_window.title": "CopyBoard 设置",
    ...
    "settings_window.appearance_desc": "自定义 CopyBoard 的外观和感觉。",
